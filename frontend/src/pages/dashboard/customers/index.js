...
const Page = () => {
  ...
  const participants = contest.data['compes-table'].slice(
    search.page * search.rowsPerPage,
    (search.page + 1) * search.rowsPerPage,
  );
  const participantsCount = contest.data['compes-table'].length;
  ...
  return (
    <>
      <Head>
        <title>Кадры | AtomAnalytics</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        <Container maxWidth="xl">
          <Stack spacing={4}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Typography variant="h4">Кадры AtomSkills 2021</Typography>
            </Stack>
            ...
            <Card>
              ...
              <CustomerListTable
                ...
                customersCount={participantsCount}
