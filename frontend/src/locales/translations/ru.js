...
export const ru = {
  [tokens.common.languageChanged]: 'Язык сменён',
  [tokens.nav.academy]: 'Academy',
  [tokens.nav.account]: 'Профиль',
  [tokens.nav.analytics]: 'Динамика',
  ...
  [tokens.nav.participants]: 'Участники',
};
